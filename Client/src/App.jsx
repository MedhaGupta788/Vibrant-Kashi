...
import AboutKashi from "./Pages/AboutKashi/AboutKashi";
import TravelGuide from "./Pages/TravelGuide/TravelGuide";
import GettingAround from "./Pages/GettingAround/GettingAround";
import AdditionalTips from "./Pages/AdditionalTips/AdditionalTips";
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route
          path="/aboutKashi"
          element={<AboutKashi headerThirteen={headingAndimage[11]} />}
        />

        <Route
          path="/travelGuide"
          element={<TravelGuide headerFourteen={headingAndimage[12]} />}
        />
        <Route
          path="/gettingAround"
          element={<GettingAround headerFifteen={headingAndimage[13]} />}
        />
        <Route
          path="/additionalTips"
          element={<AdditionalTips headerSixteen={headingAndimage[14]} />}
        />

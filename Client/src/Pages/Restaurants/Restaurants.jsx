  ...
  return (
    <div>
      ...
      <div className="detailsOfFood">
        ...
        <h2 className="subheadingOfFood">1.Vegetarian Focus:</h2>
        <div className=" descriptionOfFood">
          Most traditional dishes are vegetarian, emphasizing the city's
          spiritual roots.
        </div>

        <h2 className="subheadingOfFood">2. Local Ingredients:</h2>
        <div className=" descriptionOfFood">
        ...
        <img
          ...
          className="imageFood"
        />
        <h2 className="subheadingOfFood">3. Dairy Products:</h2>
        <div className=" descriptionOfFood">
        ...
        <h2 className="subheadingOfFood">4. Balanced Flavors: </h2>
        <div className=" descriptionOfFood">
        ...
        />
        <h2 className="subheadingOfFood">5. Festive Foods:</h2>
        <div className=" descriptionOfFood">
        ...
        <h2 className="subheadingOfFood">6.Traditional Cooking Methods: </h2>
        <div className=" descriptionOfFoods">
        ...
        <h2 className="subheadingOfFood">7. Street Food Culture: </h2>
        <div className=" descriptionOfFood">
